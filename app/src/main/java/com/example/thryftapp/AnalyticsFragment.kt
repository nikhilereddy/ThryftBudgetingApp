...
class AnalyticsFragment : Fragment() {
    ...
    //inflate layout and bind chart views
    override fun onCreateView(
        ...
        startDateInput.setOnClickListener {
            showDatePicker { date ->
                ...
                Log.d("AnalyticsFragment", "start date set to ${dateFormat.format(date)}")
        ...
        endDateInput.setOnClickListener {
            showDatePicker { date ->
                ...
                Log.d("AnalyticsFragment", "end date set to ${dateFormat.format(date)}")
        ...
        applyButton.setOnClickListener {
            if (customStartDate != null && customEndDate != null) {
                ...
                Log.d("AnalyticsFragment", "date range not selected")
        ...
        view.findViewById<ImageView>(R.id.backButton)?.setOnClickListener {
            ...
            Log.d("AnalyticsFragment", "back pressed")
